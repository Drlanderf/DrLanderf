...
<tr>
<td><img src="https://img.youtube.com/vi/{{slice .URL 32}}/default.jpg" alt="YouTube thumbnail"/></td>
<td>
<a href="{{.URL}}">{{.Title}}</a> ({{humanize .PublishedAt}}) <br/>
<img src="https://img.shields.io/youtube/views/{{slice .URL 32}}?style=flat-square" alt="YouTube views"/>
</td>
</tr>
{{- end}}
</table>
